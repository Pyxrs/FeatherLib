...
public class ARRPUtil {
    public static JLootTable blockLootTable(ID blockId, BlockRegistrySettings.LootType type) {
        return switch (type) {
    ...
    public static JState blockstate(ID blockId, BlockRegistrySettings.BlockstateType type) {
        JBlockModel model = JState.model(blockId.getNamespace() + ":block/" + blockId.getId());
        return switch (type) {
    ...
    public static JModel model(ID blockId, BlockRegistrySettings.ItemModelType type) {
        switch (type) {
            case TEXTURE:
